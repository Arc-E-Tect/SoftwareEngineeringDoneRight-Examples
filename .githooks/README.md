...
This directory contains Git hooks that enforce security standards and quality checks.
...
1. **PR Status Check**: Prevents pushing to branches with merged or closed pull requests
   ...
   - Skips check for: main, master, maintenance, section/chapter branches, worktree branches
