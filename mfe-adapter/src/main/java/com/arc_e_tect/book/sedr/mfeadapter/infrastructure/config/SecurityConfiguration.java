    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // OAuth2 callback endpoint is handled before authentication
                        .requestMatchers("/auth/callback", "/auth/logout").permitAll()
                        // Everything else requires a valid MFA session
