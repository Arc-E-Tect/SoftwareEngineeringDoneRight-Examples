...
@DisplayName("RouteMappingInnerTokenServiceAdapter")
class RouteMappingInnerTokenServiceAdapterTest {

    private final RouteMappingInnerTokenServiceAdapter adapter = new RouteMappingInnerTokenServiceAdapter();
