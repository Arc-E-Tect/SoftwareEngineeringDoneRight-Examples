...
/**
 * No-auth {@link SessionStorePort} for the route-mapping (no-session) example.
 *
...
@Primary
@Component
public class RouteMappingSessionStoreAdapter implements SessionStorePort {
    ...
    public void save(Session session) {
        // no-op – route-mapping example has no session persistence
    }
