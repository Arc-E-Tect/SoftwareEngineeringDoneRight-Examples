...
@DisplayName("VanillaInnerTokenServiceAdapter")
class VanillaInnerTokenServiceAdapterTest {

    private final VanillaInnerTokenServiceAdapter adapter = new VanillaInnerTokenServiceAdapter();
