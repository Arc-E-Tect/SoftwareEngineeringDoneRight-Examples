...
/**
 * No-auth {@link SessionStorePort} for the vanilla (no-session) example.
 *
...
@Primary
@Component
public class VanillaSessionStoreAdapter implements SessionStorePort {
    ...
    public void save(Session session) {
        // no-op – vanilla example has no session persistence
    }
