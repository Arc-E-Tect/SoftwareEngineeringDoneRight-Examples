...
@DisplayName("PayloadShaperWebClientConfiguration")
class PayloadShaperWebClientConfigurationTest {
    ...
    void microserviceWebClient_usesBaseUrl() {
        ...
        PayloadShaperWebClientConfiguration config = new PayloadShaperWebClientConfiguration(props);
