 ...
 *
 * <p>The pattern and replacement are supplied via {@link SecurityMfaProperties}
 * (bound from {@code security-mfa.routing.*} in the active YAML profile).
 *
...
public class RegexRoutingStrategy implements RoutingStrategy {
    ...
    public RegexRoutingStrategy(SecurityMfaProperties properties) {
